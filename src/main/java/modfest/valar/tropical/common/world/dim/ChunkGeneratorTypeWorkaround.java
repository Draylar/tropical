...
public class ChunkGeneratorTypeWorkaround implements InvocationHandler
{
    ...
    public TropicalChunkGenerator createProxy(World w, BiomeSource biomesource, ChunkGeneratorConfig gensettings) {
        return new TropicalChunkGenerator(w, biomesource, gensettings);
    }
