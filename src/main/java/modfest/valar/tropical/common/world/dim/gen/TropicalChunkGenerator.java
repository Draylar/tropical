...
public class TropicalChunkGenerator extends SurfaceChunkGenerator<ChunkGeneratorConfig>
{
	...
	public void buildSurface(Chunk chunk_1)
	{
		for (int x = 0; x < 16; x++)
		{
			for (int z = 0; z < 16; z++)
			{
				...
				this.biomeSource.getBiome(posX, posZ).buildSurface(new Random(234612362L * posX + -8264616432452L * posZ), chunk_1, posX, posZ, 255, blockNoise.eval(x, z), Blocks.STONE.getDefaultState(), Blocks.WATER.getDefaultState(), getSeaLevel(), world.getSeed());
			}
		}
	}
	...
	public static double getTerrainScale(double x, double z)
	{
		double noiseHeight;
