...
public class TropicalItems
{
    ...
    public static final Item MARGARITA = new MargaritaItem(DEFAULT_SETTINGS.maxCount(1));
    ...
    // food items
    private static final Item RAW_CRAB = new Item(DEFAULT_SETTINGS.food(new FoodComponent.Builder().hunger(3).build()));
    private static final Item SEARED_CRAB = new Item(DEFAULT_SETTINGS.food(new FoodComponent.Builder().hunger(6).build()));
    private static final Item BANANA = new Item(DEFAULT_SETTINGS.food(new FoodComponent.Builder().hunger(2).snack().build()));
    private static final Item PINEAPPLE = new Item(DEFAULT_SETTINGS.food(new FoodComponent.Builder().hunger(3).build()));
    private static final Item FISH_STEW = new Item(DEFAULT_SETTINGS.food(new FoodComponent.Builder().hunger(10).build()));
    ...
    private static final Item COCONUT_JUICE = new Item(DEFAULT_SETTINGS.food(new FoodComponent.Builder().hunger(3).build()));
    private static final Item SURF_AND_TURF = new Item(DEFAULT_SETTINGS.food(new FoodComponent.Builder().hunger(10).build()));
